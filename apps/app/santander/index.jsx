...
function Index() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button title={'SACAR'} onPress={() => handleButton('saque')} />
            <Button title={'DEPOSITO'} onPress={() => handleButton('deposito')} />
            <Modal
                animationType='slide'
                transparent={true}
                visible={isModalOpen}
            ...
            >
                <View style={styles.center}>
                    <View style={styles.modalBody}>
                        ...
                        <View style={styles.center}>
                            <Text style={styles.p}>Tem certeza que deseja realizar essa operação?</Text>
                            <View style={styles.column}>
                                <Text>valor Atual: R${conta.toFixed(2).replace('.', ',')}</Text>
                                <Text>valor Final: R${valorFinal().toFixed(2).replace('.', ',')}</Text>
                            </View>
                            <View style={styles.confirm}>
                                <Pressable style={styles.confirmBnt} onPress={handleConfirm}>
                                    <Text>confirmar</Text>
                                </Pressable>
                            </View>
                        </View>
